...
type Step interface {
	...
	Init(rt *runtime.ClusterRuntime, logger *logrus.Entry) error // Changed to *runtime.ClusterRuntime
	...
	Execute(rt *runtime.ClusterRuntime, logger *logrus.Entry) (output string, success bool, err error) // Changed to *runtime.ClusterRuntime
	...
	// The logger entry is pre-configured with step context.
	Post(rt *runtime.ClusterRuntime, logger *logrus.Entry, executeErr error) error // Changed to *runtime.ClusterRuntime
}
